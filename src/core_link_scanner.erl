...
-file("src/core_link_scanner.xrl", 31).
...
-file("src/core_link_scanner.erl", 284).
yystate() -> 8.
...
-file("src/core_link_scanner.xrl", 19).
yyaction_0(TokenLine) ->
     { token, { '<', TokenLine } } .

-compile({inline,yyaction_1/1}).
-file("src/core_link_scanner.xrl", 20).
yyaction_1(TokenLine) ->
     { token, { '/', TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("src/core_link_scanner.xrl", 21).
yyaction_2(TokenLine) ->
     { token, { '>', TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("src/core_link_scanner.xrl", 22).
yyaction_3(TokenLine) ->
     { token, { ';', TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("src/core_link_scanner.xrl", 23).
yyaction_4(TokenLine) ->
     { token, { ',', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("src/core_link_scanner.xrl", 24).
yyaction_5(TokenLine) ->
     { token, { '=', TokenLine } } .

-compile({inline,yyaction_6/2}).
-file("src/core_link_scanner.xrl", 26).
yyaction_6(TokenChars, TokenLine) ->
     { token, { segment, TokenLine, TokenChars } } .

-compile({inline,yyaction_7/2}).
-file("src/core_link_scanner.xrl", 27).
yyaction_7(TokenChars, TokenLine) ->
